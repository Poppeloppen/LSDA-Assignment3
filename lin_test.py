...
#mlflow.set_experiment("GRID_TEST")
...
#The number of splits to do in time serie splits
n_time_splits = [2,5,10]

#The hyperparameters to try in gridsearch
params = {"poly_features__degree": [1,2,3,4,5]}




for split in n_time_splits:
    tscv = TimeSeriesSplit(split)
    gsearch = GridSearchCV(pipe(LinearRegression()),
                            cv = tscv,
                            param_grid = params, 
